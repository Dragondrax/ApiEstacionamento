...
namespace ApiEstacionamento.Migrations
{
    ...
    [Migration("20220405191930_MigrationAddCarroReserva")]
    partial class MigrationAddCarroReserva
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.Carro", b =>
                {
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.CarteiraVirtual", b =>
                {
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.Estacionamento", b =>
                {
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.LoginModel", b =>
                {
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.Reserva", b =>
                {
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.Carro", b =>
                {
                    b.HasOne("ApiEstacionamento.Model.LoginModel", "Usuario")
                        .WithMany("Carros")
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.CarteiraVirtual", b =>
                {
                    b.HasOne("ApiEstacionamento.Model.LoginModel", "Usuario")
                        .WithOne("Carteira")
                        .HasForeignKey("ApiEstacionamento.Model.CarteiraVirtual", "user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.Estacionamento", b =>
                {
                    b.HasOne("ApiEstacionamento.Model.LoginModel", "Usuario")
                        ...
                        .HasForeignKey("ApiEstacionamento.Model.Estacionamento", "User_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApiEstacionamento.Model.Reserva", b =>
                {
                    b.HasOne("ApiEstacionamento.Model.Carro", "Carro")
                        .WithMany("Reservas")
                        .HasForeignKey("Carro_Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ApiEstacionamento.Model.Estacionamento", "Estacionamento")
                        .WithMany("Reservas")
